...
import com.blackchopper.refresh.header.internal.MaterialProgressDrawable;
import com.blackchopper.refresh.header.material.CircleImageView;
...
import com.blackchopper.refresh.core.util.SmartUtil;
...
//    }
    ...
    @Override
    public void onReleased(@NonNull Refresh layout, int height, int maxDragHeight) {
        mProgress.start();
        final View circleView = mCircleView;
     ...
     * @deprecated 请使用 {@link Refresh#setPrimaryColorsId(int...)}
     */
    @Override@Deprecated
