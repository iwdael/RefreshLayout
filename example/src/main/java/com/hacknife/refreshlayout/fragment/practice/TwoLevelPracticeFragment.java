package com.hacknife.refreshlayout.fragment.practice;
...
import com.hacknife.refresh.core.header.TwoLevelHeader;
...
public class TwoLevelPracticeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull final View root, @Nullable Bundle savedInstanceState) {
        ...
        final Refresh refreshLayout = (Refresh)root.findViewById(R.id.refreshLayout);

        header.setOnTwoLevelListener(new OnTwoLevelListener() {
            @Override
            public boolean onTwoLevel(@NonNull Refresh refreshLayout) {
