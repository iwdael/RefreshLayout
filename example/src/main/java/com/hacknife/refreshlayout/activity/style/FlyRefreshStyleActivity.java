package com.hacknife.refreshlayout.activity.style;
...
import com.hacknife.refresh.adapter.FlyRefreshHeader;
import com.hacknife.refresh.adapter.flyrefresh.FlyView;
import com.hacknife.refresh.adapter.flyrefresh.MountainSceneView;
...
public class FlyRefreshStyleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRefreshLayout = (Refresh) findViewById(R.id.refreshLayout);
        ...
        //设置 让 AppBarLayout 和 Refresh 的滚动同步 并不保持 toolbar 位置不变
