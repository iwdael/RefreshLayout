...
public interface RefreshInternal extends OnStateChangedListener {
     ...
     */
    @RestrictTo({LIBRARY,LIBRARY_GROUP,SUBCLASSES})
    void onReleased(@NonNull Refresh refreshLayout, int height, int maxDragHeight);
     ...
     */
    @RestrictTo({LIBRARY,LIBRARY_GROUP,SUBCLASSES})
    void onStartAnimator(@NonNull Refresh refreshLayout, int height, int maxDragHeight);
     ...
     */
    @RestrictTo({LIBRARY,LIBRARY_GROUP,SUBCLASSES})
    int onFinish(@NonNull Refresh refreshLayout, boolean success);
