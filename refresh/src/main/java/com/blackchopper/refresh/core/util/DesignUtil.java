package com.blackchopper.refresh.core.util;
...
public class DesignUtil {
    ...
    private static void wrapperCoordinatorLayout(ViewGroup layout/*, final Refresh refreshLayout*/, final CoordinatorLayoutListener listener) {
