...
import com.hacknife.refresh.core.api.DefaultRefreshInitializer;
import com.hacknife.refresh.core.api.Refresh;
import com.hacknife.refresh.core.api.RefreshContent;
import com.hacknife.refresh.core.api.RefreshFooter;
import com.hacknife.refresh.core.api.RefreshHeader;
import com.hacknife.refresh.core.api.RefreshInternal;
import com.hacknife.refresh.core.api.RefreshKernel;
import com.hacknife.refresh.core.api.ScrollBoundaryDecider;
import com.hacknife.refresh.core.constant.DimensionStatus;
...
import com.hacknife.refresh.core.impl.RefreshContentWrapper;
import com.hacknife.refresh.core.impl.RefreshFooterWrapper;
import com.hacknife.refresh.core.impl.RefreshHeaderWrapper;
...
import com.hacknife.refresh.core.listener.OnStateChangedListener;
import com.hacknife.refresh.core.util.DelayedRunnable;
import com.hacknife.refresh.core.util.DensityUtil;
import com.hacknife.refresh.core.util.ViscousFluidInterpolator;
...
import static com.hacknife.refresh.core.util.DensityUtil.dp2px;
import static com.hacknife.refresh.core.util.SmartUtil.fling;
import static com.hacknife.refresh.core.util.SmartUtil.getColor;
import static com.hacknife.refresh.core.util.SmartUtil.isContentView;
...
//    }
     ...
     */
    @Override
    public Refresh setEnableNestedScroll(boolean enabled) {
     ...
     */
    @Override
    public Refresh setRefreshContent(@NonNull View content) {
     ...
     */
    @Override
    public Refresh setRefreshContent(@NonNull View content, int width, int height) {
        final View thisView = this;
        if (mRefreshContent != null) {
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.hacknife.refresh.core.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link com.hacknife.refresh.core.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
...
//    }
    ...
    public class RefreshKernelImpl implements RefreshKernel {
        ...
        @NonNull
        @Override
        public Refresh getRefreshLayout() {
