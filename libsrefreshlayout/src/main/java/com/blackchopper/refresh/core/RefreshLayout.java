package com.blackchopper.refresh.core;
...
import com.blackchopper.refresh.core.api.RefreshContent;
import com.blackchopper.refresh.core.api.RefreshFooter;
import com.blackchopper.refresh.core.api.RefreshHeader;
import com.blackchopper.refresh.core.api.RefreshInternal;
import com.blackchopper.refresh.core.api.RefreshKernel;
import com.blackchopper.refresh.core.api.ScrollBoundaryDecider;
import com.blackchopper.refresh.core.constant.DimensionStatus;
import com.blackchopper.refresh.core.constant.RefreshState;
import com.blackchopper.refresh.core.constant.SpinnerStyle;
import com.blackchopper.refresh.core.impl.RefreshContentWrapper;
import com.blackchopper.refresh.core.impl.RefreshFooterWrapper;
...
import com.blackchopper.refresh.core.listener.OnStateChangedListener;
import com.blackchopper.refresh.footer.ClassicsFooter;
import com.blackchopper.refresh.header.ClassicsHeader;
import com.blackchopper.refresh.util.DelayedRunnable;
import com.blackchopper.refresh.util.DensityUtil;
import com.blackchopper.refresh.util.ScrollBoundaryUtil;
import com.blackchopper.refresh.util.ViscousFluidInterpolator;
...
import static com.blackchopper.refresh.util.DensityUtil.dp2px;
import static com.blackchopper.refresh.util.SmartUtil.fling;
import static com.blackchopper.refresh.util.SmartUtil.getColor;
import static com.blackchopper.refresh.util.SmartUtil.isScrollableView;
import static java.lang.System.currentTimeMillis;

import com.blackchopper.refresh.R;
import com.blackchopper.refresh.footer.BallPulseFooter;
import com.blackchopper.refresh.header.BezierRadarHeader;
...
//    protected int mFooterExtendHeight;  //扩展高度
    ...
    public RefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setNestedScrollingEnabled(ta.getBoolean(R.styleable.RefreshLayout_enableNestedScrolling, false));
        ...
        mHeaderHeight = ta.getDimensionPixelOffset(R.styleable.RefreshLayout_headerHeight, density.dip2px(100));
        mFooterHeight = ta.getDimensionPixelOffset(R.styleable.RefreshLayout_footerHeight, density.dip2px(60));
        mHeaderInsetStart = ta.getDimensionPixelOffset(R.styleable.RefreshLayout_headerInsetStart, 0);
        mFooterInsetStart = ta.getDimensionPixelOffset(R.styleable.RefreshLayout_footerInsetStart, 0);
        ...
        mFixedHeaderViewId = ta.getResourceId(R.styleable.RefreshLayout_fixedHeaderViewId, View.NO_ID);
        mFixedFooterViewId = ta.getResourceId(R.styleable.RefreshLayout_fixedFooterViewId, View.NO_ID);
        mHeaderTranslationViewId = ta.getResourceId(R.styleable.RefreshLayout_headerTranslationViewId, View.NO_ID);
        mFooterTranslationViewId = ta.getResourceId(R.styleable.RefreshLayout_footerTranslationViewId, View.NO_ID);
        ...
        mManualNestedScrolling = ta.hasValue(R.styleable.RefreshLayout_enableNestedScrolling);
                    ...
                    public void run() {
                        ...
                        for (ViewParent parent = thisView.getParent(); parent != null; ) {
                            if (parent instanceof NestedScrollingParent) {
                                View target = RefreshLayout.this;
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    mOnMultiPurposeListener.onRefresh(RefreshLayout.this);
...
//            reboundAnimator.setDuration(20000);
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            ...
            backgroundColor = ta.getColor(R.styleable.RefreshLayout_Layout_layout_backgroundColor, backgroundColor);
            if (ta.hasValue(R.styleable.RefreshLayout_Layout_layout_spinnerStyle)) {
                spinnerStyle = SpinnerStyle.values()[ta.getInt(R.styleable.RefreshLayout_Layout_layout_spinnerStyle, SpinnerStyle.Translate.ordinal())];
            }
            ta.recycle();
        }
                ...
                if (mState == RefreshState.Loading && mRefreshFooter != null && mRefreshContent != null) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        ...
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            RefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + offset + mTouchSlop * 2, 0));
                            RefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + offset, 0));
                            if (mNestedInProgress) {
                                mTotalUnconsumed = 0;
                            }
...
//    /**
//     * 恢复没有更多数据的原始状态
//     * @deprecated 使用 {@link Refresh#setNoMoreData(boolean)} 代替
//     * @return SmartRefreshLayout
//     */
//    @Override
//    @Deprecated
